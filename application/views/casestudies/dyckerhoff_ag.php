...
<section class="casestudy-Manufactor">
    ...
    <div class="bs-example pull-right padding-top-50">
        <ul class="breadcrumb">
            ...
            <li class="active">Dyckerhoff AG</li>
        </ul>
    </div>
</section>
<section>
    <div class="container">
        ...
        <div class="col-sm-9 col-xs-12  nopadding">
            ...
            <div class="col-xs-12">
                <h3 class="casestudyh3">Dyckerhoff AG, a 150 years old producer of cement and concrete has deployed Fiorano ESB to optimize their logistics</h3>
                <p>
