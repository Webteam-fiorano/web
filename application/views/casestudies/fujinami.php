    ...
    <div class="container">
        ...
        <div class="col-sm-9 col-xs-12  nopadding">
            ...
            <div class="col-xs-12">
                ...
                <hr>
                <h4>Fiorano SOA compresses order-delivery cycle, improves productivity</h4>
            ...
            <div class="col-xs-12 padding-top-20">
                ...
                <p><strong class="fb">Features of the new Fiorano ESB based system:</strong></p>
                
                <p>
                   <b>Business Use case driven: "Drag-Drop-Deploy"</b>
                </p>
                <p>
                   	When developing new business flows and/or user interfaces
                    ...
                    even after beta testing using just a drag-drop-deploy approach.
                </p>
                <p>
                   <b>REST component</b>
                </p>
                <p>Web based user interface screens connect to the Fiorano SOA
                 ...
                 <p>
                   <b>Remote monitoring &amp; Error handling</b>
                </p>
            ...
            <div class="col-xs-12 padding-top-20">
                ...
                <p>Founded in 1995, Silicon Valley based Fiorano is a California Corporation with proven leadership in enterprise middleware and
                    peer-to-peer distributed systems. Fiorano's innovative event-driven, dataflow SOA platform integrates applications and complex
                    technologies into an enterprise nervous system, increases business process performance, yields higher message throughput and
                    enhances availability through agent-based visual composition that bridges the capability gap between business models and their
                    implementation - the model is the application, ready to run.
               </p>
               <p>Global leaders including ABN AMRO, Boeing, British Telecom, Chicago Mercantile Exchange Group, McKesson, NASA, POSCO Steel, Qwest Communications, Rabobank, Schlumberger, Lockheed Martin, United States Coast Guard and Vodafone have deployed Fiorano to drive innovation through open, standards-based, dataflow SOA applications built in just days, yielding unprecedented productivity</p>
               <p>Fiorano Enterprise Service Bus (ESB) and Fiorano Message Queue (MQ) deliver the industry fastest, lowest latency, highest throughput
                  real-time messaging (asynchronous and synchronous) to power high performance, highly available, and collaborative workflow
                  applications whose application services are distributed throughout the IT landscape. Fiorano's distributed, peer-to-peer agents' abstract
                  complexity of developing and deploying services to unlock value in a customer's enterprise architecture framework.
			  </p>
			  <p>To find out more about how Fiorano can help you meet your enterprise integration objectives, visit <a href="/" target="_blank">www.fiorano.com</a>
				or Email: <a href="mailto:sales@fiorano.com">sales@fiorano.com</a>.</p>
            </div>
        </div>
        ...
        <div class="col-sm-3 padding-top-50 margintop-50">
            <div class="col-sm-12 col-xs-6 user-casestudy padding-top-20 padding-bottom-20">
                ...
                <img style=" padding-left: 19%;" src="<?php echo base_url('assets/images/casestudies/Fujinami-logo.jpg')?>" class="img-responsive align-right"/>
            ...
            <div class="col-sm-12 col-xs-6 padding-top-20 padding-bottom-20">
                <a href="<?php echo  base_url('assets/pdf/casestudy/CS_Fujinami.pdf')?>" target="_blank">
