    ...
    <div class="container">
        <div class="col-xs-12">
            <div class="section-header">
                <h1 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Press Releases</sup></h1>
            </div>
        </div>
    </div>
</section>
...
<section id="cd-timeline" class="cd-container even-section">
    <div class="container">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date"> Sep 15, 2016</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date"> Mar 24, 2016</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
        <span class="cd-date">   Jan 14, 2016</span>
            </div>
            <div class="cd-timeline-content">
                <h2>Fiorano Software expands footprint into Cambodian Market</h2>
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date">    Dec 03, 2015 </span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date"> Oct 31, 2013 </span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date">    Sept 24, 2013</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date">  Sept 17, 2013  </span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date">  Sept 3, 2013 </span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date">   July 18, 2013  </span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date">   Jan 14, 2013</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date">    Oct 5, 2012 </span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date">   March 20, 2012</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            ...
            <div class="cd-timeline-content">
                ...
                <h2>Fiorano becomes first ITK Middleware vendor to be awarded
        ...
        <div class="cd-timeline-block nextOne">
            <div class="cd-timeline-img cd-picture">
                <span class="cd-date">  Sept 13, 2011</span>
            </div>
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-movie">
                <span class="cd-date"> Sept 7,&nbsp;2011</span>
            </div> <!-- cd-timeline-img -->
            <div class="cd-timeline-content">
        ...
        <div class="cd-timeline-block nextOne">
            ...
            <div class="cd-timeline-content">
                ...
                <h2>GSA exercises 5 year contract renewal option with Fiorano for IT Schedule 70 COTS software </h2>
        ...
        <div class="cd-timeline-block nextOne">
            ...
            <div class="cd-timeline-content">
                ...
                <h2> Fiorano throws down the gauntlet to messaging middleware vendors &ndash;
                    pumps up version 9.3.0 of its turbo-charged FioranoMQ JMS Messaging Server</h2>
