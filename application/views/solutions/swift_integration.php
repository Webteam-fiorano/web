        ...
        <div class="col-xs-12">
           ...
           <!-- <div class="pull-right"><a href="#connectivity">Connectivity</a> <span style="color:#333;font-size:15px;">|</span>
            ...
            <h2>Fiorano SWIFT Solution Architecture</h2>
                ...
                <div class="col-sm-12">
                    <p class="text-center align-center"><a href="<?php echo base_url('assets/images/solutions')?>/fiorano-swift-solution-architecture-hd.jpg" target="_blank" title="Click to enlarge"><img src="<?php echo base_url('assets/images/solutions')?>/fiorano-swift-solution-architecture.jpg" alt="Fiorano SWIFT Solution Architecture" /></a></p>
                </div>
...
<section class="even-section">
    ...
    <div class="container">
        ...
        <div class="col-xs-12 padding-bottom-50 ">
            ...
            <div class="col-xs-7">
                <table  class=" col-xs-12 swiftTable" border="1" bordercolor="cccccc" cellspacing="0" cellpadding="7" align="center" style="border-collapse:collapse">
...
<section>
    <div class="container">
        ...
        <div class="col-xs-12 padding-bottom-50">
            ...
            <div class="col-sm-3 messBox">
                <div class="messBoxSub">
    ...
    <div class="container padding-bottom-50">
        <div class="row">
            <div class="section-header">
                ...
                <h2 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Supported Message Types (MT) are noted below:</h2>

            </div>
        </div>
        <div class="col-xs-12">
            <table  class="col-xs-8" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <table class="col-sm-11 tableData" border="1" bordercolor="cccccc" cellspacing="0" cellpadding="4" style="">
                            <tr style="background-color:#00599C;color:#ffffff">
                                <td width="" style="padding:5px"><strong>MT</strong></td>
                                <td style="padding:5px"><strong>MT Name</strong></td>
                            </tr>
                            <tr>
                                <td>101</td>
                    ...
                    <td valign="top">
                        <table class="col-sm-11 tableData" border="1" bordercolor="cccccc" cellspacing="0" cellpadding="5" style="">
                            <tr style="background-color:#00599C;color:#ffffff">
                                <td width="" style="padding:5px"><strong>MT</strong></td>
                                <td style="padding:5px"><strong>MT Name</strong></td>
                            </tr>
            ...
            <table  class="col-sm-3" border="1" bordercolor="cccccc" cellspacing="0" cellpadding="7" style="">
                <tr style="background-color:#00599C;color:#ffffff">
                    <td><strong>MX</strong></td>
                    <td><strong>MX Messages</strong></td>
                </tr>
                <tr>
                    <td>camt.052</td>
