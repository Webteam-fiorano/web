<!-- Intro Section -->
<section id="intro" class="about-section-banner">
    <div class="container">
        <div class="col-xs-12 productBanner ">
            <div class="productHead col-sm-8">
                <h1 class="productHeadTitle">About Fiorano<sup style="font-size: 16px;top: -.7666em;">®</sup></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="section-header">
                    <h1 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">About Fiorano<sup style="font-size: 16px;top: -.7666em;">®</sup></h1>

                </div>
                <div class="col-lg-10 col-sm-offset-1 col-sm-7 productLeft" style="padding-top: 0% !important;">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <p class="productDesc padding-bottom-50" >
                        ...
                        <br>
                        <br>
                        Global leaders including ABN AMRO, Boeing, British Telecom, Capgemini Telecom, Chicago Mercantile Exchange Group, McKesson, NASA, POSCO Steel, Qwest Communications, Rabobank, Schlumberger, Lockheed Martin, United States Coast Guard and Vodafone have deployed Fiorano to drive innovation through open, standards-based microservices built in just days, yielding unprecedented productivity.
                        <br>
                        <br>
                        Fiorano API Management, Fiorano Enterprise Service Bus (ESB), B2B and Message Queuing products together power high-performance, highly available, collaborative digital systems whose application services are distributed throughout the IT landscape.  Fiorano’s distributed, peer-to-peer agents abstract the complexity of developing and deploying services to unlock value in a customer’s enterprise architecture framework, enabling a clear path to Digitalization.
                    </p>
                </div>
               <!-- <div class="col-lg-5 col-sm-5 ">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-12 "><a href="<?php /*echo __ROOT__*/?>/docs/fiorano_corp_brochure.pdf" target="_blank"><img class="about-brochure" src="<?php /*echo base_url('assets/images/home/corp_brochure_168x203.gif')*/?>" alt="View Corporate Brochure"></a></div>
                    <div class="col-xs-12"><a href="<?php /*echo __ROOT__*/?>/docs/fiorano_corp_brochure.pdf" target="_blank">View Corporate Brochure</a></div>
                    <div class="col-sm-1"></div>
                </div>-->
            </div>
        </div>
