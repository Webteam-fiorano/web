...
<?php
$webinar= "Avoiding the Perils and Pitfalls of Cloud-Based Integration";
...
<section>
    <div class="container">
        <div class="col-xs-12">
            ...
            <div class="col-sm-7">
                <p>
                    Old-guard middleware vendors would have you believe that all you need to do to move your enterprise integration to the cloud is simply to use one of their aging middleware products, warmed over as integration Platform-as-a-Service (iPaaS).
                </p>
                <p >
                    Don't buy it. Integration in the cloud is fundamentally different from on-premise, middleware-based approaches. The cloud is inherently decentralized, horizontally scalable, and elastic -- characteristics that are entirely alien to yesterday's middleware.
                </p>
                <p >
                    Watch industry analyst Jason Bloomberg, president of Intellyx, and Atul Saini, CEO of Fiorano Software, discuss the challenges that arise with cloud based integration. Bloomberg will contrast traditional middleware approaches with cloud-based iPaaS, and point out what to look for from iPaaS that is built for the cloud.
                    Saini will conclude the session with a look at Fiorano's iPaaS solution, and will discuss the critical architectural decisions Fiorano made early on that uniquely positioned them for a cloud-centric world.
                </p>
