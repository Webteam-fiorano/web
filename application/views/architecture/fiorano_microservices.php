...
<section id="intro" class="microservice-section">
    ...
    <div class="bs-example pull-right">
        <ul class="breadcrumb">
            ...
            <li> <a href="<?php echo site_url('products/fiorano_microservices'); ?>"> Fiorano Microservice</a></li>
    ...
    <div class="container">
        ...
        <div class="col-xs-12 padding-bottom-50 padding-top-50 padding-top-hidxs padding-bottom-hidxs">
            ...
            <div class="col-sm-6 nopadding col-xs-12">
                ...
                <div class="col-xs-12 mic-box-6 mic-box padding-bottom-20  padding-top-10">
                    <h3>Services as Independent "Products"</h3>
                    <p class="padding-top-10">Each Microservice created on the Fiorano platform is an independent product in itself. Each Service is self-contained, includes all dependencies (such as libraries, etc.) as part of its packaging and is developed, tested and deployed independently of other services. As such, whenever a Service is modified or has functionality added to it, the changes can be made available to existing applications that use that Service at very short notice. The Fiorano runtime in fact allows "hot replacement" of services, where an upgrade to a service can be made at run-time, without stopping the overall application. Such changes are not allowed, for instance, in 'process-centric' integration platforms (those based on BPEL and associated standards).
                    </p>
                </div>
                <div class="col-xs-12 mic-box-7 mic-box padding-bottom-20  padding-top-10">
                    <h3>Decentralized Data Management</h3>
                    <p class="padding-top-10">Each Fiorano Microservice manages its own data as part of the business logic implemented in the Microservice. A centralized data-source, as in the development of a classical monolithic application, is not needed. Each Microservice manages its own persistence layer, which may be different instances of a single database technology or entirely different database systems in different Microservices. There are no "global variables" in such an architecture since there is no centralized data-store provided by the platform. All information is carried as part of the payload that flows between Microservices distributed across the network.
                    </p><p>
                        The use of separate persistence mechanisms across different Microservices mandates that error-recovery in distributed transactions be implemented by compensating operations. The emphasis in a Microservices architecture is on transaction less coordination between services, with transactions being individually managed within each Microservice using the inbuilt JMS support for distributed transitions or other Transaction Processing Monitors.
                    </p>
                </div>
                <div class="col-xs-12 mic-box-8 mic-box padding-bottom-20  padding-top-10">
                    <h3>Decentralized Governance and Multi-language support</h3>
                    <p class="padding-top-10" >Since each Fiorano Microservice is fully decoupled from other services, it can be developed in any supported language and governed independently. Fiorano supports the development of Microservices in Java, C, C++, C#, JavaScript and other scripting languages. Each Service can be governed, modified, replaced and deployed independently of the other, providing flexibility to both development and deployment teams.
                    </p>
                </div>
