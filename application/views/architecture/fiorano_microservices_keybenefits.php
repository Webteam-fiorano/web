...
<section id="tooo">
    <div class="section-header padding-bottom-50">
        <h3 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Key Benefits </h3>
    </div>
    <div class="container my_slider">
            <div class="text-center we_do">
                <h4 class="do"> Easy, unbounded Scalability </h4>
            ...
            <div class="text-center we_do">
                <h4 class="do"> Independent Teams for Service Development and Application Assembly </h4>
            ...
            <div class="text-center we_do">
                <h4 class="do">Multi-language Development for added Flexibility </h4>
            ...
            <div class="text-center we_do">
                <h4 class="do">Ideal granularity to enable agility and reuse </h4>
            ...
            <div class="text-center we_do">
                <h4 class="do">Easier testing and deployment across multiple Environments</h4>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.my_slider').slick({
            ...
            slidesToShow: 1,
            speed: 500,
            nextArrow:"<img class='a-right control-c prev slick-next' src='/assets/images/products/right_arrow.jpg'>",
            prevArrow:"<img class='a-left control-c prev slick-prev' src='/assets/images/products/left_arrow.jpg'>",
            responsive: [{
    ...
    $(document).ready(function() {
        ...
        $('.padding-top-20').css('min-height', divHeight+'px');
    });
